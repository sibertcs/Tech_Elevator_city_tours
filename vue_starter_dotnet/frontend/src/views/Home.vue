<template>
  <div class="nav-button">
    <div class="home">
      <h1>You Get a Tour! and You Get a Tour! Everone Gets a Tour!</h1>
      <div class="site-search">
        <landmark-search v-on:search="searchforResult"></landmark-search>
        <landmark-search-results v-if="showLandmarkResults" v-bind:searchQuery="searchQuery"></landmark-search-results>
      </div>
    </div>
  </div>
</template>
